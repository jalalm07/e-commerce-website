...
public class AuthController {
	...
	public AuthController(UserRepository userRepository, PasswordEncoder passwordEncoder, JwtTokenProvider jwtTokenProvider, CustomUserDetails customUserDetails, CartService cartService, AddressRepository addressRepository) {
	...
	public ResponseEntity<AuthResponse> createUserHandler(@Valid @RequestBody User user) throws UserException{
		...
		newAddress.setZipCode(zip);
			...
			createdUser.setCreditCardNumber(creditCardNumber);
	        createdUser.setPassword(passwordEncoder.encode(password));
	        
	        User savedUser= userRepository.save(createdUser);
			newAddress.setUser(savedUser);
			Address add = addressRepository.save(newAddress);

			savedUser.getAddresses().add(add);
